...
def test_keep(nw_frame_constructor: Constructor) -> None:
...
def test_keep_after_alias(nw_frame_constructor: Constructor) -> None:
    df = nw.from_native(nw_frame_constructor(data))
...
def test_keep_anonymous(nw_frame_constructor: Constructor) -> None:
