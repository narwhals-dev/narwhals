...
def test_map(nw_frame_constructor: Constructor) -> None:
...
def test_map_after_alias(nw_frame_constructor: Constructor) -> None:
...
def test_map_anonymous(nw_frame_constructor: Constructor) -> None:
