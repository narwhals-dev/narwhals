...
data_other = {"a": [1, 4, 2, 5], "b": [1, 0, 2, 0]}


def test_filter_is_in(constructor_eager: ConstructorEager) -> None:
    df = nw.from_native(constructor_eager(data_other), eager_only=True)
