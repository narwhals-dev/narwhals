...
def test_coalesce_numeric(nw_frame_constructor: Constructor) -> None:
    data = {
...
def test_coalesce_strings(nw_frame_constructor: Constructor) -> None:
    data = {
        "a": ["0", None, None, None, None],
        "b": ["1", None, None, "5", "3"],
        "c": ["5", None, "3", "2", "1"],
...
def test_coalesce_series(nw_eager_constructor: ConstructorEager) -> None:
    data = {
        "a": ["0", None, None, None, None],
        "b": ["1", None, None, "5", "3"],
        "c": ["5", None, "3", "2", "1"],
...
def test_coalesce_raises_non_expr(nw_frame_constructor: Constructor) -> None:
    data = {
        "a": ["0", None, None, None, None],
        "b": ["1", None, None, "5", "3"],
        "c": ["5", None, "3", "2", "1"],
