...
XFAIL_NO_IMPL_YET = pytest.mark.xfail(
    reason="Not added `ArrowExpr.is_first_distinct` yet", raises=AttributeError
)


@XFAIL_NO_IMPL_YET
def test_is_first_distinct_expr() -> None:
...
@XFAIL_NO_IMPL_YET
def test_is_first_distinct_expr_order_by() -> None:
