...
| Operation | Null                                          | NaN                                                                                                                                                                                                                                              |
| --------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| is        | [`Expr.is_null`](../api-reference/expr.md#narwhals.Expr.is_null)       | [`Expr.is_nan`](../api-reference/expr.md#narwhals.Expr.is_nan)                                                                                                                                                                                                            |
| fill      | [`Expr.fill_null`](../api-reference/expr.md#narwhals.Expr.fill_null)   | [`Expr.fill_nan`](../api-reference/expr.md#narwhals.Expr.fill_nan)                                                                                                                                                                                                        |
| drop      | [`Expr.drop_nulls`](../api-reference/expr.md#narwhals.Expr.drop_nulls) | *Not yet implemented (See [discussion](https://github.com/narwhals-dev/narwhals/issues/3031#issuecomment-3219910366))*<br>[`polars.Expr.drop_nans`](https://docs.pola.rs/api/python/stable/reference/expressions/api/polars.Expr.drop_nans.html) |
| count     | [`Expr.null_count`](../api-reference/expr.md#narwhals.Expr.null_count) | *No upstream equivalent*                                                                                                                                                                                                                         |
...
def check_null_behavior(df: IntoFrameT | IntoLazyFrameT) -> IntoFrameT | IntoLazyFrameT:
    return (
        nw.from_native(df)
