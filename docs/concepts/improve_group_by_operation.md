...
=== "Approach 1"
    ...
    def approach_1(df_native: IntoFrameT | IntoLazyFrameT) -> IntoFrameT | IntoLazyFrameT:
...
=== "Approach 2"
    ...
    def approach_2(df_native: IntoFrameT | IntoLazyFrameT) -> IntoFrameT | IntoLazyFrameT:
        df = nw.from_native(df_native)
