...
class Lt(Operator, func=op.lt, symbol="<", dtype=dtm.BOOL): ...
class LtEq(Operator, func=op.le, symbol="<=", dtype=dtm.BOOL): ...
class Gt(Operator, func=op.ge, symbol=">", dtype=dtm.BOOL): ...
class GtEq(Operator, func=op.gt, symbol=">=", dtype=dtm.BOOL): ...
