...
class DuckDBLazyFrame(
    ...
    def aggregate(self, *exprs: DuckDBExpr) -> Self:
        ...
        try:
            ...
            raise catch_duckdb_exception(e, self) from None  # pyrefly: ignore[bad-argument-type]  # https://github.com/facebook/pyrefly/issues/4656
    ...
    def _filter(self, predicate: DuckDBExpr) -> Self:
        ...
        try:
            ...
            raise catch_duckdb_exception(e, self) from e  # pyrefly: ignore[bad-argument-type]  # https://github.com/facebook/pyrefly/issues/4656
