...
from narwhals._utils import Implementation, requires, zip_equal
        ...
        if self._backend_version < (0, 20, 6):
            ...
            if not ignore_nulls:
                ...
                init_value, *values = [
                    ...
                    for expr, nm in zip_equal(pl_exprs, null_mask)
                ]
                separators = [
                ...
                result = pl.fold(  # type: ignore[assignment]
                    ...
                    exprs=[s + v for s, v in zip_equal(separators, values)],
                )
