...
class ArrowSeriesStringNamespace(ArrowSeriesNamespace):
    def len_chars(self: Self) -> ArrowSeries:
        return self.compliant._from_native_series(pc.utf8_length(self.native))
    ...
    def replace(
        ...
        return self.compliant._from_native_series(arr)
    ...
    def contains(self: Self, pattern: str, *, literal: bool) -> ArrowSeries:
        ...
        return self.compliant._from_native_series(check_func(self.native, pattern))
    ...
    def to_datetime(self: Self, format: str | None) -> ArrowSeries:  # noqa: A002
        ...
        return self.compliant._from_native_series(timestamp_array)

    def to_uppercase(self: Self) -> ArrowSeries:
        return self.compliant._from_native_series(pc.utf8_upper(self.native))

    def to_lowercase(self: Self) -> ArrowSeries:
        return self.compliant._from_native_series(pc.utf8_lower(self.native))
