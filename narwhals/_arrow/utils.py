...
def native_to_narwhals_dtype(dtype: pa.DataType, version: Version) -> DType:  # noqa: C901
...
def narwhals_to_native_dtype(dtype: DType | type[DType], version: Version) -> pa.DataType:  # noqa: C901
    dtypes = version.dtypes
