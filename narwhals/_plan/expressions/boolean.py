...
# fmt: off
class BooleanFunction(Function, options=elementwise, dtype=dtm.BOOL):...
class _HorizontalBoolean(HorizontalFunction, BooleanFunction, dtype=dtm.BOOL):
    __slots__ = ("ignore_nulls",)
    ignore_nulls: bool
class All(BooleanFunction, options=aggregation): ...
class Any(BooleanFunction, options=aggregation): ...
class AllHorizontal(_HorizontalBoolean):...
class AnyHorizontal(_HorizontalBoolean):...
class IsDuplicated(BooleanFunction, options=length_preserving): ...
class IsFinite(BooleanFunction): ...
class IsFirstDistinct(BooleanFunction, options=length_preserving): ...
class IsLastDistinct(BooleanFunction, options=length_preserving): ...
