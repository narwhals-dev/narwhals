...
@t.overload
def concat_str(
    *arrays: ChunkedArrayAny | str, separator: str = ..., ignore_nulls: bool = ...
) -> ChunkedArray[StringScalar]: ...
@t.overload
def concat_str(
    *arrays: ArrayAny | str, separator: str = ..., ignore_nulls: bool = ...
) -> Array[StringScalar]: ...
@t.overload
def concat_str(
    *arrays: ScalarAny | str, separator: str = ..., ignore_nulls: bool = ...
) -> StringScalar: ...
def concat_str(
