...
from narwhals.dependencies import is_sqlalchemy_table
...
def _from_native_impl(  # noqa: PLR0915
    ...
    *,
    ...
    # PySpark
    ...
    elif is_sqlalchemy_table(native_object):  # pragma: no cover
        ...
        return LazyFrame(
            SQLAlchemyLazyFrame(
                native_object,
                backend_version=parse_version(get_sqlalchemy().__version__),
                version=version,
            ),
            level="lazy",
        )
